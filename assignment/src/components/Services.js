...
<div className='col-sm-12 col-md-6 col-lg-6'><h5 style={{color:'#05b993',float:'left',marginBottom:'1rem'}}>Our Services</h5></div>
...
<section class="scrollport">
  ...
  <div className='col-sm-12 col-md-4 col-lg-3'> <img src='cloud.png' className="img-fluid" style={{padding:'0.2rem',borderRadius:"100%",height:'7rem'}}></img><br></br><br></br>
  ...
  <div className='col-sm-12 col-md-4 col-lg-3'> <img src='it.jpg' className="img-fluid" style={{padding:'0.2rem',borderRadius:"100%",height:'7rem'}}></img><br></br><br></br>
  <h6 style={{color:"#05b993"}}>IT assistance</h6>
  <p style={{color:"green"}}>Comprehensive IT support and assistance to ensure smooth operations and minimize downtime.</p>
  </div>
